      ...
      <div className="container" style={{ maxWidth: '800px', color: 'var(--navy)' }}>
        <ScrollReveal>
          ...
          <div className="legal-content" style={{ lineHeight: 1.8, fontSize: '16px' }}>
            ...
            <p>Permission is granted to temporarily download one copy of the materials (information or software) on Nashied Digital Boutique's website for personal, non-commercial transitory viewing only.</p>

            <h2 style={{ fontSize: '24px', margin: '40px 0 20px', color: 'var(--navy)' }}>3. Logistics Services</h2>
            <p>Any logistics or transportation services provided by Nashied Digital Boutique are governed by separate commercial agreements and are subject to the standard terms of trade applicable in the transport sector of Zimbabwe.</p>

            <h2 style={{ fontSize: '24px', margin: '40px 0 20px', color: 'var(--navy)' }}>4. Limitations</h2>
            <p>In no event shall Nashied Digital Boutique or its partners be liable for any damages arising out of the use or inability to use the materials on Nashied Digital Boutique's website.</p>

            <h2 style={{ fontSize: '24px', margin: '40px 0 20px', color: 'var(--navy)' }}>5. Governing Law</h2>
            <p>Any claim relating to Nashied Digital Boutique's website shall be governed by the laws of the Republic of Zimbabwe without regard to its conflict of law provisions.</p>
          </div>
        </ScrollReveal>
      </div>
    </div>
